...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class PlayServicesLibraryAccessors extends SubDependencyFactory {
        private final PlayServicesCodeLibraryAccessors laccForPlayServicesCodeLibraryAccessors = new PlayServicesCodeLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>play.services.code</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public PlayServicesCodeLibraryAccessors getCode() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForPlayServicesCodeLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class PlayServicesCodeLibraryAccessors extends SubDependencyFactory {

        public PlayServicesCodeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>scanner</b> with <b>com.google.android.gms:play-services-code-scanner</b> coordinates and
         * with version reference <b>playServicesCodeScanner</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getScanner() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.code.scanner");
        }
    ...
    public static class PlayServicesMlkitLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>play.services.mlkit.text</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class PlayServicesMlkitTextLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Group of libraries at <b>play.services.mlkit.text.recognition</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
    ...
    public static class PlayServicesMlkitTextRecognitionLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>common</b> with <b>com.google.android.gms:play-services-mlkit-text-recognition-common</b> coordinates and
         * with version reference <b>playServicesMlkitTextRecognitionCommon</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        /**
         * Dependency provider for <b>korean</b> with <b>com.google.android.gms:play-services-mlkit-text-recognition-korean</b> coordinates and
         * with version reference <b>playServicesMlkitTextRecognitionKorean</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
        ...
        public Provider<MinimalExternalModuleDependency> getKorean() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("play.services.mlkit.text.recognition.korean");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>playServicesCodeScanner</b> with value <b>16.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesCodeScanner() { return getVersion("playServicesCodeScanner"); }

        /**
         * Version alias <b>playServicesMlkitTextRecognitionCommon</b> with value <b>19.1.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>playServicesMlkitTextRecognitionKorean</b> with value <b>16.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getPlayServicesMlkitTextRecognitionKorean() { return getVersion("playServicesMlkitTextRecognitionKorean"); }
